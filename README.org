...
+ [[https://github.com/emacsomancer/pdffontetc][emacsomancer/pdffontetc]] :: Show information about PDFs and their metadata.
...
+ Add user-option ~pdf-meta-edit-command~
+ Also fontify "PageLabelPrefix"
